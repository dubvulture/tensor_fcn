...
class BatchDataset(object):
    ...
    def __init__(self,
        ...
        :param batch_size:
        :param image_size:
        :param image_op: function called to transform the data, identity function if None
            mainly used for cropping and resizing using informations specific to the dataset
        :param augment_data: whether to futher augment data by applying some simple transformations (edit by your needs)
        """
    ...
    def _batch_read(self, pos):
        ...
        This should be used when batch size > 1
    ...
    def _simple_read(self, pos):
        ...
        This should be used only when batch size == 1
